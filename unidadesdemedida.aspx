<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="unidadesdemedida.aspx.cs" Inherits="_UnidadesDeMedida" %>
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label>Id</label>
                        <asp:Label ID="tbIdunidaddemedida" runat="server" class="form-control bg-gray"></asp:Label>
                    </div>
                    <!-- Nombre -->
                    <div class="form-group">
                        <label>Unidad de Medida</label>
                        <asp:TextBox ID="tbUnidaddemedida" runat="server" class="form-control"></asp:TextBox>
                    </div>
                    <!-- /.form group -->
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnRowCommand="GridView1_RowCommand">
                        ...
                        <Columns>
                            <asp:BoundField DataField="idunidaddemedida" HeaderText="ID" SortExpression="idunidaddemedida" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FARMACIASTOPConnectionString %>" SelectCommand="SELECT idunidaddemedida, unidaddemedida, fechacreacion FROM FTOP10106"></asp:SqlDataSource>
