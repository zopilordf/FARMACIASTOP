<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="estados.aspx.cs" Inherits="_Estados" %>
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label>Id</label>
                        <asp:Label ID="tbIdEstado" runat="server" class="form-control bg-gray"></asp:Label>
                    </div>
                    <!-- Nombre -->
                    <div class="form-group">
                        <label>Estado</label>
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnRowCommand="GridView1_RowCommand">
                        ...
                        <Columns>
                            <asp:BoundField DataField="idEstado" HeaderText="ID" SortExpression="idEstado" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FARMACIASTOPConnectionString %>" SelectCommand="SELECT idEstado, Estado, fechacreacion FROM FTOP10105"></asp:SqlDataSource>
