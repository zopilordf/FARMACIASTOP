<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="tiposproducto.aspx.cs" Inherits="_Tiposproducto" %>
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label>Id</label>
                        <asp:Label ID="tbIdTiposproducto" runat="server" class="form-control bg-gray"></asp:Label>
                    </div>
                    <!-- Nombre -->
                    <div class="form-group">
                        <label>Tiposproducto</label>
                        <asp:TextBox ID="tbTiposproducto" runat="server" class="form-control"></asp:TextBox>
                    </div>
                    <!-- Descripcion -->
                    <div class="form-group">
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnRowCommand="GridView1_RowCommand">
                        ...
                        <Columns>
                            <asp:BoundField DataField="IdTiposproducto" HeaderText="ID" SortExpression="IdTiposproducto" InsertVisible="False" ReadOnly="True" />
                            <asp:BoundField DataField="Tiposproducto" HeaderText="Parámetro" SortExpression="Tiposproducto" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FARMACIASTOPConnectionString %>" SelectCommand="SELECT [IdTiposproducto], [Tiposproducto], [descripcion], [fechacreacion] FROM [FTOP10103]"></asp:SqlDataSource>
